...
import com.aks.group.breakout.room.ContactListFragment.OnListFragmentInteractionListener;
...
public class ContactListRecyclerViewAdapter extends RecyclerView.Adapter<ContactListRecyclerViewAdapter.ViewHolder> {
    ...
    public ContactListRecyclerViewAdapter(List<ContactInfo> items, ContactListFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).getContactEmailId());
